...
const Header = () => {
  return (
    <div
      ...
      lg:h-screen lg:w-32 flex justify-center items-end 
      lg:items-center pb-8 lg:pb-0 z-50
    "
    >
      <div
        className="text-white px-4 py-3 lg:py-12 rounded-full 
      border-[rgba(255,255,255,0.3)] flex flex-row lg:flex-col items-center 
